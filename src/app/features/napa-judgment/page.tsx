  ...
  return (
    <div className="grain" style={{ minHeight: '100vh' }}>
      ...
      <div style={{ paddingTop: '200px', textAlign: 'center' }}>
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '0.65rem', letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--gold)' }}>Feature</p>
        <h1 style={{ fontFamily: 'var(--font-display)', fontSize: '3rem', fontWeight: 300, color: 'var(--cream)', marginTop: '1rem' }}>The Judgment of Paris</h1>
