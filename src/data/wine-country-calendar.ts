...
export const CALENDAR_SEASONS: CalendarSeason[] = [
  {
    ...
    paragraphs: [
      ...
      "Downtown Napa coffee shops are warming and welcoming stops, too: Naysayer, Ohm, Moulin, and Ritual are among the best. There's also Ohm's Roastery and Coffee Lab in the Rail Arts District of downtown Napa, where you can get a private lesson on brewing methods, latte art or coffee cupping. Chocolate lovers will find that area chocolatiers will be happy to inspire you and your Valentine. Anette's is a local favorite for its hot chocolate. Le Belge creates chocolates specifically to pair with wines; their Cabernet Sauvignon offerings include a dark chocolate/lavender/black currant and a dark chocolate/espresso. Earth & Sky craft dramatic bonbons, petite works of art. Woodhouse in St. Helena is known for its homemade s'mores.",
    ],
  },
  {
    months: 'March / April',
