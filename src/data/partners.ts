...
export const partners: PartnerDestination[] = [
  ...
  },
  {
    ...
    gallery: gallery('walt-napa-oxbow', [
      ...
      'Guests at the WALT Napa Oxbow tasting bar beneath gold pendant lights',
      'Private lounge seating and contemporary art at WALT Napa Oxbow',
      'Couple enjoying Pinot Noir amid the Hall collection at WALT Napa Oxbow',
      'The WALT Napa Oxbow tasting room on First Street in the Oxbow district',
      'Outdoor patio seating with WALT umbrellas steps from Oxbow Public Market',
