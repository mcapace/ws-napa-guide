...
- **Coordinates:** [TBD - geocode at build]
...
Properties grouped here for inclusion in the Oakville map and listings sidebar.
...
<span className="region-sidebar-sc">Two of the most anticipated reopenings in Napa this year</span> are scheduled to open soon: Robert Mondavi Winery (RMW) in May and Beaulieu Vineyard (BV) by July, and they are offering reservations as of press time in April.
